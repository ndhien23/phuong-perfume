                                    	...
                                    	<c:forEach items="${sessionScope.gioHang.danhSachSanPhamMua() }" var="spm">
	                                        <tr class="cart_item">
	                                            ...
	                                            <td class="product-price">
	                                            	...
	                                            	<fmt:formatNumber value="${spm.donGiaKM }" var="num1"></fmt:formatNumber>
	                                                <span class="amount">${num1 } VNĐ</span> 
	                                            </td>
	                                            ...
	                                            <td class="product-subtotal">
	                                            	<fmt:formatNumber value="${spm.thanhTien() }" var="num2"></fmt:formatNumber>
	                                                <span class="amount">${num2 } VNĐ</span> 
	                                            </td>
	                                        </tr>
	                                        <tr>
